...
{
    public static class YaziyaCevir // 3. eğitimin 34. bölümü 11:31 den itibaren udemy de de not alındı.
    {
        ...
        {
            return (value >= 100 ? (value >= 200 ? Birler[value / 100] : "") + "Yüz" : "")
                + (value % 100 >= 10 ? Onlar[value % 100 / 10] : "") + Birler[value % 10];
        }
