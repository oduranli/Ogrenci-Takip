...
using OzgurYazilim.OgrenciTakip.UI.Win.Reports.XtraReports;
using OzgurYazilim.OgrenciTakip.UI.Win.Reports.XtraReports.Fatura;
using OzgurYazilim.OgrenciTakip.UI.Win.Reports.XtraReports.Makbuz;
using OzgurYazilim.OgrenciTakip.UI.Win.Reports.XtraReports.Tahakkuk;
...
namespace OzgurYazilim.OgrenciTakip.UI.Win.GeneralForms
{
    public partial class RaporSecim : BaseListForm
    {
        ...
        public RaporSecim(params object[] prm)
        {
            ...
            txtYazdirmaSekli.EditValue = YazdirmaSekli.TekTekYazdir;
        ...
        protected override void DegiskenleriDoldur()
        {
            ...
            if (_raporBolumTuru == RaporBolumTuru.FaturaDonemRaporlari || _raporBolumTuru == RaporBolumTuru.FaturaGenelRaporlar || _raporBolumTuru == RaporBolumTuru.MakbuzRaporlari)
            {
                ...
                {
                    btnBosRapor,
                    btnOgrenciKarti, btnBankaOdemePlani, btnIndirimTalepDilekcesi, btnMebKayitSozlesmesi, btnKayitSozlesmesi,
        ...
        private void ReportDataSource(IReport rapor)
        {
            switch (rapor)
            {
                case OgrenciKartiRaporu rpr:
                    ...
                    rpr.Indirim_Bilgileri.DataSource = _iletisimBilgileri;
        ...
        {
            if (Messages.EvetSeciliEvetHayir("Rapor yazdırılmak üzere seçmiş olduğunuz yazıcıya gönderilecektir. Onaylıyor musunuz?", "Yazdırma Onayı!") != DialogResult.Yes) return;
