...
using OzgurYazilim.OgrenciTakip.UI.Win.UserControls.UserControl.TahakkukEditFormTable;
using System;
...
namespace OzgurYazilim.OgrenciTakip.UI.Win.Forms.TahakkukForms
{
    public partial class TahakkukEditForm : BaseEditForm
    {
        ...
        public TahakkukEditForm()
        {
            ...
            txtKayitTarihi.Properties.MinValue = AnaForm.DonemParemetreleri.DonemBaslamaTarihi;
            txtKayitTarihi.Properties.MaxValue = AnaForm.DonemParemetreleri.DonemBitisTarihi;
        ...
        protected internal override void ButonEnabledDurumu()
        {
            ...
            if (hizmetBilgileriTable.TableValueChanged || indirimBilgileriTable.TableValueChanged
                || odemeBilgileriTable.TableValueChanged || geriOdemeBilgileriTable.TableValueChanged)
                Toplamlar();

            if (FarkliSubeIslemi)
                Functions.GeneralFunctions.ButonEnabledDurumu(btnYeni, btnKaydet, btnGeriAl, btnSil);
            else
                Functions.GeneralFunctions.ButonEnabledDurumu(btnYeni, btnKaydet, btnGeriAl, btnSil, OldEntity, CurrentEntity, TableValueChanged());
        }
