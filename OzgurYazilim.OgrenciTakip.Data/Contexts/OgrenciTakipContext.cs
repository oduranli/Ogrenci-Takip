using OzgurYazilim.OgrenciTakip.Data.OgrenciTakipMigration;
...
namespace OzgurYazilim.OgrenciTakip.Data.Contexts
{
    public class OgrenciTakipContext : BaseDbContext<OgrenciTakipContext, Configuration>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Il>().HasMany(x => x.Ilce).WithRequired().WillCascadeOnDelete(true); //(baðlý olan ilçe kartlarýný beraber silebilmek için kullanýldý)
        ...
        public DbSet<DonemParemetre> DonemParemetre { get; set; }
