...
namespace OzgurYazilim.OgrenciTakip.Model.Dto
{
    ...
    public class GenelAmacliRaporL
    {
        ...
        public string VeliEvTelefonu { get; set; }
        public string VeliIsTelefonu1 { get; set; }
        public string VeliIsTelefonu2 { get; set; }
        public string VeliCepTelefonu1 { get; set; }
        public string VeliCepTelefonu2 { get; set; }
    ...
    [NotMapped]
    public class IndirimDagilimiRaporuL
    {
        public long OgrenciId { get; set; }
        public long TahakkukId { get; set; }
        public long SubeId { get; set; }
